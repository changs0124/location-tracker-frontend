export const breakpoints = {
  mobile: 430,           // ~640px (세로 모드 스마트폰)
  mobileLandscape: 932,  // ~932px (가로 모드 스마트폰)
  tablet: 1024,          // 641px ~ 1024px (태블릿)
  tabletLandscape: 1366, // 1366px (가로 모드 태블릿)
...
export const media = {
  ...
  tabletLandscape: `@media (min-width: ${breakpoints.tablet + 1}px) and (max-width: ${breakpoints.tabletLandscape}px)`,
