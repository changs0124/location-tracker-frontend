...
function BottomBar({ delivery, setDelivery, isShowCargoLoations, setIsShowCargoLocations, cargoLocations, isShowProducts, setIsShowProducts, products, isTracking, onClick1, onClick2 }) {
